...
Learning : React Router | JavaScript | Web Development
...
|--------|-------------|------|
| 🛒 [PH Play Store](https://github.com/azizul-dev/ph-play-store) | A play store clone project | JavaScript |
| 🎬 [Movie Tracker](https://github.com/azizul-dev/movie-tracker) | Track your favorite movies | JavaScript |
| 📚 [Book Vibe](https://github.com/azizul-dev/book-vibe) | Book collection app | JavaScript |
| 🤖 [AI Model Hub](https://github.com/azizul-dev/ai-model-hub) | AI model showcase website | JavaScript |
...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Hi+there!+I'm+Azizul+Islam+👋;Frontend+Developer+from+Bangladesh+🇧🇩;Currently+Learning+React+Router+⚛️;Exploring+Next.js+⚡;Building+Cool+Projects+Every+Day+🚀" alt="Typing SVG" />
</div>
...
* 🚀 Learning Next.js & building SSR apps
...
| Project                                                         | Description                                | Tech       |
| --------------------------------------------------------------- | ------------------------------------------ | ---------- |
| 🛒 [PH Play Store](https://github.com/azizul-dev/ph-play-store) | A play store clone with interactive UI     | JavaScript |
| 🎬 [Movie Tracker](https://github.com/azizul-dev/movie-tracker) | Track & manage your favorite movies easily | JavaScript |
| 📚 [Book Vibe](https://github.com/azizul-dev/book-vibe)         | Organize and explore your book collection  | JavaScript |
| 🤖 [AI Model Hub](https://github.com/azizul-dev/ai-model-hub)   | Showcase and explore AI tools & models     | JavaScript |
