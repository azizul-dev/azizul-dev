...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Hi+there!+I'm+Azizul+Islam+👋;Frontend+Developer+from+Bangladesh+🇧🇩;Currently+Learning+React+Router+⚛️;Exploring+Next.js+⚡;Building+Real+Projects+🚀" alt="Typing SVG" />
</div>
...
| 🐱 [pet-adoption-platform](https://github.com/azizul-dev/assignment-9)       | Interactive book discovery and reading tracker featuring wishlist management, reading progress monitoring, responsive layouts, and smooth user experience.          | [Live](https://assignment-9-beta.vercel.app/)      | React.js, React Router, Tailwind CSS, JavaScript               |
